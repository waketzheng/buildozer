...
class TestBuildozer(unittest.TestCase):
    ...
    def test_android_ant_path(self):
        ...
        # Mock first run
        with (
            mock.patch("buildozer.buildops.download") as download,
...
class TestCopyApplicationSources(unittest.TestCase):
    ...
    def create_buildozer(self, custom_config=None):
        ...
        spec_parser_patch = mock.patch(
            "buildozer.SpecParser", return_value=mock_spec_parser
        )
        ...
        check_config_patch = mock.patch.object(
            __import__("buildozer").Buildozer, "check_configuration_tokens", mock.Mock()
        )
    ...
    def test_ignore_hidden_files_and_directories_in_source(self, mock_buildops):
        ...
        self.assertTrue(any("visible" in f and "code.py" in f for f in copied_files))
        self.assertTrue(any("subdir" in f and "code2.py" in f for f in copied_files))
    ...
    def test_source_dir_with_hidden_parent(self, mock_buildops):
        ...
        hidden_source = os.path.join(self.temp_dir, ".hidden_parent", "project")
        ...
        custom_config = {("app", "source.dir", "."): hidden_source}
    ...
    def test_include_extensions_filter(self, mock_buildops):
        ...
        custom_config = {("app", "source.include_exts", ""): ["py", "png"]}
    ...
    def test_exclude_dirs_filter(self, mock_buildops):
        ...
        custom_config = {("app", "source.exclude_dirs", ""): ["tests", "venv"]}
        ...
        self.assertTrue(any("main.py" in f for f in copied_files))
        self.assertTrue(any("src" in f and "code.py" in f for f in copied_files))
    ...
    def test_exclude_patterns(self, mock_buildops):
        ...
        custom_config = {("app", "source.exclude_patterns", ""): ["license", "*.jpg"]}
